...
<body>
	...
	<div class="main-w3layouts wrapper">
		 ...
		 <?php if(!empty($_GET['message'])){
            ...
            <div class="error" style="color: red;font-size: 18px;margin-left: 465px;margin-top: 20px"> <?php echo $message ; ?></div>
		...
		<div class="main-agileinfo">
			<div class="agileits-top">
                            <form action="signup.php" method="post">
                                <input class="text" name="name" type="text"  placeholder="Username" required="">
					<input class="text email" name="email" type="email"  placeholder="Email" required="">
